...
window.epLiveCopyLocalStorage = window.epLiveCopyLocalStorage || (function () {
    ...
    function isApiReady() {
        if (!wasInit) {
            console.log('You must call epLiveCopyLocalStorage.init() before using it.');
            return false;
        }
        if (!iframeReady) {
    ...
    return {
        ...
        init   : function (customOptions) {
            ...
            if (wasInit) {
                console.log('epLiveCopyLocalStorage was already initialized!');
                return;
            }
            wasInit = true;
            if (isDomReady()) {

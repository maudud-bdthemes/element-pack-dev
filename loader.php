...
class Element_Pack_Loader {
    ...
    public function enqueue_site_styles() {
        ...
        wp_enqueue_style('bdt-uikit', BDTEP_ASSETS_URL . 'css/bdt-uikit' . $direction_suffix . '.css', [], '3.16.24');
    ...
    public function enqueue_site_scripts() {
        ...
        wp_enqueue_script('bdt-uikit', BDTEP_ASSETS_URL . 'js/bdt-uikit' . $suffix . '.js', ['jquery'], '3.16.24', true);
